...
public class ProductCardView: ViewControl {
    ...
    private func setup() {
        ...
        container.addSubview(productinfoLabel)
        productinfoLabel.anchorToSuperView(bottomRelation: .ignore,
                                           leading: 16.0,
                                           trailing: 16.0,
                                           top: 16.0,
                                           bottom: 16.0)
        ...
        stack.anchorToSuperView(topAnchor: productinfoLabel.bottomAnchor,
                                leading: 16,
                                trailing: 16,
                                top: 16, bottom: 16)
