...
public protocol ScratchPadImageViewDelegate {
...
public class ScratchPadImageView: UIImageView {
    ...
    public var delegates = [ScratchPadImageViewDelegate?]()
    ...
    public func addDelegate(delegate: ScratchPadImageViewDelegate?) {
